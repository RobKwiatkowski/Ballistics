...
while height>0:
    ...
    #height = h_max - GRAVITY*time_fall**2/2
...
while True:
	q1 = raw_input("Print the trajectory with drag? (y/n)")
	if q1=="y":
		plt.plot(x,y)
...
while True:
	q2 = raw_input("Print the trajectory without drag? (y/n)")
	if q2=="y":
...
while True:
	q3 = raw_input("Overlay both trajectories? (y/n)")
	if q3=="y":
		plt.plot(x,y,x_ref,y_ref)
		plt.xlabel("Distance [m]")
		plt.ylabel("Height [m]")
		plt.ylim(ymin=0)
		plt.show()
